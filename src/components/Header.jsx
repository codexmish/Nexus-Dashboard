...
const Header = ({sidebarCollaps, onToggleSidebar}) => {
  return (
    <>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-slate-800 dark:text-white">
                Welcome back, Dipjol! here's what's heppening today
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-md mx-8">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus-within:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
